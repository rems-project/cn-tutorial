...
The informal specifications for this example come from Dr. Bryan Parno at Carnegie-Mellon University.
...
Although the traffic lights have type `int`, we can assign values to red and green
and then define them as constants to make them more readable. 
